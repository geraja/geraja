...
function game_folder($game_code = null, $user_folder = null) {
	if($game_code && $user_folder) {

		$folder_path = './data/' . $user_folder . '/' . $game_code;
...
function user_folder($name_user_folder = null) {
	if($name_user_folder) {

		$folder_path = './data/' . $name_user_folder;
